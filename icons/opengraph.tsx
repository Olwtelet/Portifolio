  ...
  element: (
    ...
    >
      <div style={{ fontFamily: '"Golos Text Bold"' }} tw="flex flex-col">
        <h1 tw="text-[#00A824] py-8 text-7xl">Isaac Rodrigues</h1>
        <h2 tw="text-[#32352C] pt-8 text-8xl">Full-stack AI Developer</h2>
      </div>
      <h3 tw="text-[#32352C] text-6xl">React • Next.js • AWS</h3>
      <h4 tw="text-[#00A824] opacity-30 p-8 text-5xl mt-auto ml-auto">olwtelet.dev</h4>
    </div>
  )
} satisfies Icon
